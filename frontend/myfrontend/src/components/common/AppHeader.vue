    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div class="navbar">
        <div class="container-xxl">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="/records/dashboard">
            ...
            <li class="nav-item"   v-if="canAny([ 'disciplinaryRecords.view', 'disciplinaryRecords.create', 'disciplinaryRecords.update', 'disciplinaryRecords.assignToHRM', 'disciplinaryRecords.registerCase', 'disciplinaryRecords.processCase', 'disciplinaryRecords.directorProcessCase'])">
              <a class="nav-link" href="/records/disciplinary-records/list-records">
                ...
                <span class="nav-link-title"> Disciplinary Records </span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/records/users/list-users">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="nav-item">
              <a class="nav-link" href="/records/ict/help-desk">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-users">
                ...
                <span class="nav-link-title"> Help Desk System </span>
              </a>
            </li>
          
            <li class="nav-item">
              <a class="nav-link" href="/records/guests/guests-management">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-users">
                ...
                <span class="nav-link-title"> Guest Management System </span>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/records/badges/visitor-badges">
                ...
                <span class="nav-link-title"> Visitor Badges </span>
              </a>
            </li>
          </ul>
          <!-- search form  -->
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="/records/settings" class="dropdown-item">Settings</a>
